...
from agents_ae.helpers import EMA
...
class Diffusion_QL(object):
    ...
    def train(self, replay_buffer, iterations, batch_size=100, log_writer=None):
        ...
        metric = {'bc_loss': [], 'ql_loss': [], 'actor_loss': [], 'critic_loss': [],'bca_loss': [],'bcs_loss': []}
        for _ in range(iterations):
            ...
            """ Policy Training """
            bc_loss_a,bc_loss_s = self.actor.loss(action, state)
            bc_loss = bc_loss_a + self.scale_state*bc_loss_s
            ...
            if log_writer is not None:
                ...
                log_writer.add_scalar('BCA Loss', bc_loss_a.item(), self.step)
                log_writer.add_scalar('BCS Loss', bc_loss_s.item(), self.step)
            ...
            metric['bca_loss'].append(bc_loss_a.item())
            metric['bcs_loss'].append(bc_loss_s.item())
